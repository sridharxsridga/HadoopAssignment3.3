/*
 * UnitsSoldPerStateForOnidaDriver is a driver class which drives the execution of map reduce programs
 */
...
import unitsSoldPerCompany.UnitsSoldPerCompanyDriver;
import unitsSoldPerCompany.UnitsSoldPerCompanyMapper;
import unitsSoldPerCompany.UnitsSoldPerCompanyReducer;

public class UnitsSoldPerStateForOnidaDriver {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		//Set the Jar by finding where a given class came from UnitsSoldPerStateForOnidaDriver
		job.setJarByClass(UnitsSoldPerStateForOnidaDriver.class);
		...
		job.setMapperClass(UnitsSoldPerStateForOnidaMapper.class);
		
		//set the reducer class
		job.setReducerClass(UnitsSoldPerStateForOnidaReducer.class);
		/*
